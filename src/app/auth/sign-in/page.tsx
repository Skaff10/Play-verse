    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md space-y-8 agency-card p-8 bg-[#1A1825] border border-[#2E2B40]">
        <div className="text-center space-y-2">
          <span className="agency-badge text-xs font-bold uppercase">[ USER AUTHENTICATION ]</span>
          <h1 className="text-3xl font-extrabold text-[#FFFFFE] font-display">Welcome Back</h1>
          <p className="text-xs text-[#94A1B2] font-serif-accent italic">Sign in to your PlayVerse account & sync XP</p>
        </div>
        ...
        <p className="text-center text-xs text-[#94A1B2] font-serif-accent italic">
          ...
          <Link href="/auth/sign-up" className="text-[#4ECDC4] hover:underline font-bold font-sans">
            Sign Up
          </Link>
        </p>
      </div>
